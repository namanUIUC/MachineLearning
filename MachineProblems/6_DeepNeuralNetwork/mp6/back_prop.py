...
class Neural_Network():
    ...
    def error_at_layer1(self, delta_k, W, b):
        ...
        '''
        delta_j = np.matmul(delta_k,(np.transpose(W)))*self.sigmoidPrime(b)
        return delta_j
    ...
    def derivative_of_w(self, b, delta_k):
        ...
        '''
        d_w = np.matmul(np.transpose(b),delta_k)
        return d_w
    ...
    def derivative_of_u(self, X, delta_j):
        ...
        '''
        d_u = np.matmul(np.transpose(X),delta_j)
        return d_u
